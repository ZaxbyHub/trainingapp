...
- Size budget (measured, devstation, 2026-09-23): staged resources 4,108,286,464 bytes = 3.83 GiB (embedding 134,098,874 + reranker 36,025,863 + llm-quality 3,606,025,056 + llm-fast 332,128,736 + packs 1,695 + docs 6,240) + ~112.7 MB shell ≈ 4.2 GB total — held against the ≤7 GiB budget with the component table recorded in `bench/RESULTS.md`; README storage figures updated to the measured total.
